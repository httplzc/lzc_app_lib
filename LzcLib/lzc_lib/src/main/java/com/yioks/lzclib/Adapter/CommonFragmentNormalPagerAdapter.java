 ...
 */
public class CommonFragmentNormalPagerAdapter extends FragmentPagerAdapter {
    ...
    public CommonFragmentNormalPagerAdapter(FragmentManager fm)
    {
        super(fm);
    }
    public CommonFragmentNormalPagerAdapter(FragmentManager fm, List<TabData>tabDataList, List<Fragment> fragmentList) {
        super(fm);
