 ...
 */
public abstract class RefreshRecycleListActivity<T extends Bean> extends ReceiverTitleBaseActivity implements RefreshRecycleViewParentView.LoaddingMoreListener, RefreshScrollParentViewBase.onCenterReFreshListener
    ...
    public void initView() {
        parentView = (RefreshRecycleViewParentView) findViewById(R.id.parent_view);
