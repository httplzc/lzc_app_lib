 ...
 * Time: 15:37
 */
public class RefreshParentScrollViewManager extends RefreshParent.RefreshParentManager<ScrollView>{
    @Override
    ...
    @Override
    protected void addScrollListener(OnScrollListener<ScrollView> scrollListener) {
